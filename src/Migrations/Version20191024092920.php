 ...
 */
final class Version20191024092920 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_reward (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, mvp_award_name VARCHAR(100) NOT NULL, dpoy_award_name VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_2B83696E4EC001D1 (season_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
