 ...
 */
final class Version20191023171954 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE badge DROP attribute_level');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE badge ADD attribute_level DOUBLE PRECISION NOT NULL');
    }
}
