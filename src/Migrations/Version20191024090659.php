 ...
 */
final class Version20191024090659 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_reward (id INT AUTO_INCREMENT NOT NULL, season_id INT NOT NULL, name VARCHAR(80) NOT NULL COLLATE utf8mb4_unicode_ci, type VARCHAR(60) NOT NULL COLLATE utf8mb4_unicode_ci, INDEX IDX_2B83696E4EC001D1 (season_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
