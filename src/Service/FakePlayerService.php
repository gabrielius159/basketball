...
class FakePlayerService
{
     ...
     */
    public function createFakePlayer(Team $team, string $position, int $iterations = 1): void
    {
     ...
     * @throws \Doctrine\ORM\NonUniqueResultException
     */
    private function createFakePlayerStatsOnPlayerCreate(Player $player)
    {
     ...
     * @param Player $player
     */
    private function createFakePlayerAttributes(Player $player)
    {
